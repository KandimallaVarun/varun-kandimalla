          ...
          >
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-5xl font-extrabold text-on-surface editorial-spacing leading-[1.1]">
                Hi, I'm
                <span className="text-primary block text-5xl md:text-6xl">Varun Kandimalla</span>
              </h1>
            ...
            <p className="text-lg text-on-surface-variant leading-relaxed max-w-xl">
              I build scalable, high-performance backends paired with intuitive, minimalist frontends. My approach focuses on clean architecture and intentional user experiences.
            </p>
